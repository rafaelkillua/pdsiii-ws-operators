 ...
 * @apiError (401) {String} detalhes Detalhes do erro
 * @apiError (401) {String} operadora Operadora que foi buscado.
 * @apiError (401) {String} cod-loja Loja de onde partiu a compra.
 * @apiError (401) {String} bandeira Bandeira requisitada.
 * @apiError (401) {String} parcelas_solicitadas Quantidade de parcelas solicitadas.
 * @apiError (401) {String} limite_parcelas Limite de parcelas da bandeira.
 * 
 ...
 *  
*/
router.post('/pay/:operator', (req, res) => {
  return res.send('pay operator')
})
